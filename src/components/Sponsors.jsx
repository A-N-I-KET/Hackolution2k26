...
const sponsorsData = [
    ...
    { name: 'Featherless.ai', link: 'https://featherless.ai/', imgSrc: '/assets/SPONSOR/featherlessai.avif', tier: 'The Silver Sponsor', desc: 'Run open-source AI models with zero infrastructure hassle. Serverless inference that scales effortlessly.', style: { transform: 'scale(1.5)' } },
    ...
    { name: 'interviewbuddy', link: 'https://interviewbuddy.net/', imgSrc: '/assets/SPONSOR/interviewbuddy.png', tier: 'The Silver Sponsor', desc: 'InterviewBuddy is a free AI-powered interview preparation platform that helps students and professionals prepare for job interviews.', style: { transform: 'scale(1.0)' } },
    { name: 'Mastra.ai', link: 'https://mastra.ai/', imgSrc: '/assets/SPONSOR/mastra.avif', tier: 'The Bronze Sponsor', desc: 'The open-source TypeScript AI agent framework. Build, test, and deploy AI agents with ease.', style: { transform: 'scale(1.5)' } },
    { name: 'XYZ', link: 'https://gen.xyz/', imgSrc: '/assets/SPONSOR/xyz.avif', tier: 'The Bronze Sponsor', desc: 'The domain for the next generation of internet users. Affordable, memorable, and perfect for your next big idea.', style: { transform: 'scale(1.0)' } },
    { name: 'Appwrite', link: 'https://appwrite.io/', imgSrc: '/assets/SPONSOR/appwrite.avif', tier: 'The Bronze Sponsor', desc: 'An open-source backend platform for building secure web and mobile apps with auth, databases, and storage.', style: { transform: 'scale(1.0)' } },
    { name: 'Navan Ai', link: 'https://navan.ai/', imgSrc: '/assets/SPONSOR/navam.avif', tier: 'The Bronze Sponsor', desc: 'Navan is a full-stack AI development platform that helps you build, deploy, and scale AI applications.', style: { transform: 'scale(1.0)' } },
];
                    ...
                    {sponsorsData.map((s) => (
                        ...
                        >
                            ...
                            <div className="vintage-img-wrapper sponsor-img-override">
                                {s.imgSrc ? (
                                    <img src={s.imgSrc} alt={s.name} className="vintage-col-img" style={s.style} loading="lazy" />
                                ) : (
