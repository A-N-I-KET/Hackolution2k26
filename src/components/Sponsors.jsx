...
const sponsorsData = [
    ...
    { name: 'PujoPlanner', link: 'https://pujoplanner.com', imgSrc: '/assets/SPONSOR/pujoplanner.png', tier: 'The Silver Sponsor', desc: 'Your ultimate Durga Puja companion - discover pandals with smart route planning, real-time updates, and convenient Pujo-related services all in one place', style: { transform: 'scale(1.5)' } },
