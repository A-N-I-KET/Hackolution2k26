...
const judgesData = [
    { name: 'AVIK AGARWALA', role: "SYSTEMS ENGINEER @ TCS", imgSrc: '/assets/JUDGES/AVIK.avif', desc: 'A recognized pioneer in the field of artificial thought. He insights guide our technical evaluations with precise logic.', linkedin: 'https://www.linkedin.com/in/avikagarwala/' },
    ...
    { name: 'NANDA DAS', role: 'Ex Full Stack Developer @ CyberPeak', imgSrc: '/assets/JUDGES/nanda.avif', desc: 'He has a deep understanding of the latest web technologies and is passionate about building scalable and secure applications.', linkedin: 'https://www.linkedin.com/in/nanda-das/' },
    { name: 'Narendra Nath Chatterjee', role: 'SENIOR ANDROID DEVELOPER @ Ajaib', imgSrc: '/assets/JUDGES/narendra.avif', desc: 'A seasoned architect of mobile experiences, he has crafted some of the most seamless and intuitive applications in the market. He values clean code and user-centric design.', linkedin: 'https://www.linkedin.com/in/narendra-nath-chatterjee-8a7651133/' },
];
